...
class Dokuman(models.Model):
    ...
    gelis_nedeni = models.TextField()
    parca = models.TextField()
    eksik_malzemeler = models.TextField()
    ...
    izolasyon_degerleri = models.TextField()
    calisma_akimi = models.CharField(max_length=255)
    calisma_gerilimi = models.CharField(max_length=255)
    diger_olcum_degerleri = models.TextField()
    test_cihazlari = models.TextField()
